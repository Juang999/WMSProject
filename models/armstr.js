...
module.exports = (sequelize, DataTypes) => {
  ...
  ArMstr.init({
    ...
    ar_eff_date: DataTypes.DATEONLY,
    ar_amount: DataTypes.DECIMAL,
    ar_pay_amount: DataTypes.DECIMAL,
    ar_disc_date: DataTypes.DATEONLY,
    ar_due_date: DataTypes.DATEONLY,
    ar_expt_date: DataTypes.DATEONLY,
    ar_exc_rate: DataTypes.DECIMAL,
    ...
    ar_close_date: DataTypes.DATEONLY
  }, {
    sequelize,
    schema: 'public',
    tableName: 'ar_mstr',
